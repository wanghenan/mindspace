...
### Definition of Done
- [x] 所有 7 个提供商的适配器实现完成并通过测试
- [x] 设置页面 UI 实现，用户可以选择提供商、输入密钥、选择模型
- [x] API 密钥验证功能工作正常（格式检查 + 连接测试）
- [x] 聊天页面显示当前使用的模型信息
- [x] 错误处理覆盖所有已知错误场景（401, 429, 500 等）
- [x] 所有测试通过（单元测试 ≥80% 覆盖率，集成测试全部通过）
- [x] 文档更新（README、API 文档、用户指南）
